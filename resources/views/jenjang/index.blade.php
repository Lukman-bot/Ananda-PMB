...
@section('content')
<!-- Partial Component For Data Jenjang -->
@include('jenjang.component.javascript.datatable')
<!-- End Partial Component For Data Jenjang -->
<div class="row">
    <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Cari Jenjang"
                    ...
                    <table class="table table-bordered" style="height: 100%" id="tb">
                        <thead>
                            <tr>
                                ...
                                <th class="text-truncate" style="text-align: center;">Nama Jenjang</th>

                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Cari Periode"
                    ...
                    <table class="table table-bordered" style="height: 100%" id="tb">
                        <thead>
                            <tr>
                                ...
                                <th class="text-truncate" style="text-align: center;">Tahun Akademik</th>
                                <th class="text-truncate" style="text-align: center;">Semester</th>
